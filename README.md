...
- [StackPicks](https://stackpicks.dev/mcp) - Curated directory of MCP servers with install commands, remote-vs-local flags, auth notes, and hand-written curator takes on when each server is worth using.
